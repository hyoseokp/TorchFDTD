...
\author{Hyoseok Park}
\date{랩미팅 · 2026년 9월}
\titlegraphic{\hfill\includegraphics[width=3.4cm]{figures/chart-cpu-gpu.pdf}}
...
\begin{frame}[fragile]{같은 프로젝트를 세 가지 입구에서}
  \begin{columns}[T]
    \begin{column}{.48\textwidth}
      \begin{center}\includegraphics[width=\textwidth]{figures/ui-sphere-viewports.png}\end{center}
...
\begin{frame}{해석해와 비교 2: TFSF 구 산란 vs Mie 급수}
  \begin{columns}[T]
    \begin{column}{.52\textwidth}
      \begin{center}\includegraphics[width=\textwidth]{figures/chart-mie.pdf}\end{center}
    \end{column}
    \begin{column}{.44\textwidth}
      \begin{itemize}\footnotesize
...
\begin{frame}{우리 연구 대상으로 직접 계산 2: W1 선결함 도파로}
  \begin{columns}[T]
    \begin{column}{.62\textwidth}
      \begin{center}\includegraphics[width=\textwidth]{figures/field-phc-w1.pdf}\end{center}
    \end{column}
...
\begin{frame}{배치: 같은 문제를 CPU와 GPU로}
  \begin{columns}[T]
    \begin{column}{.46\textwidth}
      \begin{center}\includegraphics[width=\textwidth]{figures/chart-cpu-gpu.pdf}\end{center}
      \caveat{4개 독립 구 케이스, 64$^3$, 800 스텝. 워커를 2/4개로 늘려도 이 문제에서는 더 빨라지지 않습니다.}
    \end{column}
    \begin{column}{.5\textwidth}
      \begin{center}\includegraphics[width=\textwidth]{figures/chart-grouped.pdf}\end{center}
...
\begin{frame}{배치 축의 한계도 같이 봅니다}
  \begin{columns}[T]
    \begin{column}{.5\textwidth}
      \begin{center}\includegraphics[width=\textwidth]{figures/chart-batch-scaling.pdf}\end{center}
    \end{column}
    \begin{column}{.46\textwidth}
      \begin{itemize}\footnotesize
...
\begin{frame}{VRAM보다 큰 문제를 푸는 방법}
  \begin{columns}[T]
    ...
    \begin{column}{.49\textwidth}
      \begin{center}\includegraphics[width=\textwidth]{figures/chart-beyond-vram.pdf}\end{center}
      \vspace{1mm}
      \footnotesize
...
\begin{frame}[fragile]{설계 루프: 지금 돌아가는 형태}
  \begin{columns}[T]
    \begin{column}{.46\textwidth}
      \begin{center}\includegraphics[width=\textwidth]{figures/chart-design-loop.pdf}\end{center}
